...
public class Temperatura extends JFrame implements Vrednost{
	...
	public Temperatura() {
		...
		btnIzr.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Celsius
				if(comboBox.getSelectedItem().equals("Celsius") && comboBox_1.getSelectedItem().equals("Celsius"))
					textField_1.setText(textField.getText().toString());
				
				if(comboBox.getSelectedItem().equals("Celsius") && comboBox_1.getSelectedItem().equals("Kelvin")) {
					double rez = num1 - Vrednost.CelToKelvin;
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Celsius") && comboBox_1.getSelectedItem().equals("Fahrenheit")) {
					double rez = num1 * 9/5 + Vrednost.CelToFah;
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				// Kelvin
				if(comboBox.getSelectedItem().equals("Kelvin") && comboBox_1.getSelectedItem().equals("Kelvin"))
					textField_1.setText(textField.getText().toString());
				
				if(comboBox.getSelectedItem().equals("Kelvin") && comboBox_1.getSelectedItem().equals("Celsius")) {
					double rez = num1 + Vrednost.kelvinToCel;
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Kelvin") && comboBox_1.getSelectedItem().equals("Fahrenheit")) {
					double rez = num1 * 9/5 + Vrednost.kelvinToFah;
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}				
				
				// Fahrenheit
				if(comboBox.getSelectedItem().equals("Fahrenheit") && comboBox_1.getSelectedItem().equals("Fahrenheit"))
					textField_1.setText(textField.getText().toString());
				
				if(comboBox.getSelectedItem().equals("Fahrenheit") && comboBox_1.getSelectedItem().equals("Celsius")) {
					double rez = (num1 +  Vrednost.FahToCel) * 5/9;
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Fahrenheit") && comboBox_1.getSelectedItem().equals("Kelvin")) {
					double rez = (num1 +  Vrednost.FahToKelvin) * 5/9;
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}	
			}
