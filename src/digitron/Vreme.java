...
public class Vreme extends JFrame {
	...
	public Vreme() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Sekund", "Minut", "Sat", "Dan"}));
		comboBox.setBounds(10, 11, 126, 22);
		contentPane.add(comboBox);
		
		comboBox_1 = new JComboBox();
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Sekund", "Minut", "Sat", "Dan"}));
		...
		btnIzr.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Sekund
				if(comboBox.getSelectedItem().equals("Sekund") && comboBox_1.getSelectedItem().equals("Sekund"))
					textField_1.setText(textField.getText().toString());
				
				if(comboBox.getSelectedItem().equals("Sekund") && comboBox_1.getSelectedItem().equals("Minut")) {
					double rez = num1 * Vrednost.sToM;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Sekund") && comboBox_1.getSelectedItem().equals("Sat")) {
					double rez = num1 * Vrednost.sToH;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Sekund") && comboBox_1.getSelectedItem().equals("Dan")) {
					double rez = num1 * Vrednost.sToD;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				...
				// Minut
				if(comboBox.getSelectedItem().equals("Minut") && comboBox_1.getSelectedItem().equals("Minut"))
					textField_1.setText(textField.getText().toString());
				
				if(comboBox.getSelectedItem().equals("Minut") && comboBox_1.getSelectedItem().equals("Sekund")) {
					double rez = num1 * Vrednost.mTos;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Minut") && comboBox_1.getSelectedItem().equals("Sat")) {
					double rez = num1 * Vrednost.mToH;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Minut") && comboBox_1.getSelectedItem().equals("Dan")) {
					double rez = num1 * Vrednost.mToD;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}	
				...
				// Sat
				if(comboBox.getSelectedItem().equals("Sat") && comboBox_1.getSelectedItem().equals("Sat"))
					textField_1.setText(textField.getText().toString());
				
				if(comboBox.getSelectedItem().equals("Sat") && comboBox_1.getSelectedItem().equals("Sekund")) {
					double rez = num1 * Vrednost.hToS;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Sat") && comboBox_1.getSelectedItem().equals("Minut")) {
					double rez = num1 * Vrednost.hToM;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Sat") && comboBox_1.getSelectedItem().equals("Dan")) {
					double rez = num1 * Vrednost.hToD;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}	
				...
				// Dan
				if(comboBox.getSelectedItem().equals("Dan") && comboBox_1.getSelectedItem().equals("Dan"))
					textField_1.setText(textField.getText().toString());
				
				if(comboBox.getSelectedItem().equals("Dan") && comboBox_1.getSelectedItem().equals("Sekund")) {
					double rez = num1 * Vrednost.dToS;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Dan") && comboBox_1.getSelectedItem().equals("Minut")) {
					double rez = num1 * Vrednost.dToM;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}
				
				if(comboBox.getSelectedItem().equals("Dan") && comboBox_1.getSelectedItem().equals("Sat")) {
					double rez = num1 * Vrednost.dToh;
					d.format(rez);
					rezultat = String.valueOf(rez);
					textField_1.setText(rezultat);
				}	
